...
> **Setup note:** Place this file at the root of the repo alongside a `screenshots/` folder containing the 20 images below (same filenames). GitHub will then render every image inline automatically.
...
*Generated from live app screenshots, 28 June 2026.*
